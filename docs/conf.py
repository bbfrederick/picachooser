...
#import picachooser
version = '1.0.0rc2'  # picachooser.__version__
# The full version, including alpha/beta/rc tags.
release = '1.0.0rc2'  # picachooser.__version
...
latex_documents = [
    (master_doc, 'picachooser.tex', 'picachooser Documentation',
...
man_pages = [
    (master_doc, 'PICAchooser', 'PICAchooser Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'PICAchooser', 'PICAchooser Documentation',
     author, 'PICAchooser', 'One line description of project.',
     'Miscellaneous'),
]
...
linkcode_resolve = make_linkcode_resolve('picachooser',
