...
# Form implementation generated from reading ui file 'picachooser_imonlyaltTemplate.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.altwidget = QtWidgets.QWidget(self.centralwidget)
        self.altwidget.setObjectName("altwidget")
        self.image_altgraphicsView = GraphicsLayoutWidget(self.altwidget)
        self.image_altgraphicsView.setEnabled(True)
        self.image_altgraphicsView.setGeometry(QtCore.QRect(0, 0, 1720, 739))
        ...
        self.horizontalLayout.addWidget(self.altwidget)
