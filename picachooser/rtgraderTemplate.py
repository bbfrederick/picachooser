...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(
            _translate(
                "MainWindow",
                'Right and left arrows step through datasets (Shift for rejected datasets, Ctrl/Cmd for accepted). Up and down arrows toggle status.  "r" to reset to first dataset.  "a", "c", and "s" select axial, coronal, or sagittal view.  ESC to write grade file.  "b" to swap windows. ',
            )
        )
