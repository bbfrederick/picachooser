...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pane1_label = QtWidgets.QLabel(parent=self.centralwidget)
        self.pane1_label.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.pane1_label.setObjectName("pane1_label")
        self.verticalLayout.addWidget(self.pane1_label)
        self.image_graphicsView_1 = GraphicsLayoutWidget(parent=self.centralwidget)
        ...
        self.pane2_label = QtWidgets.QLabel(parent=self.centralwidget)
        self.pane2_label.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.pane2_label.setObjectName("pane2_label")
        self.verticalLayout_2.addWidget(self.pane2_label)
        self.image_graphicsView_2 = GraphicsLayoutWidget(parent=self.centralwidget)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "Right and left arrows step through components. Up and down arrows toggle sortmode.  \"r\" to reset component.  \"a\", \"c\", and \"s\" select axial, coronal, or sagittal views.  ESC to write component file.  \"b\" to blink! "))
