...
description = "grader: a gui tool for assigning ratings to timecourses"
...
repository README_.
.. _README: https://github.com/bbfrederick/grader/blob/master/README.md
License
=======
``grader`` is licensed under the terms of the Apache 2 license. See the file
...
URL = "http://github.com/bbfrederick/grader"
DOWNLOAD_URL = ""
LICENSE = "Apache"
...
VERSION = __version__
PACKAGE_DATA = {'grader': [pjoin('data', '*')]}
